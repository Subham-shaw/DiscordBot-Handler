...
module.exports = {
    ...
    run: async (client, interaction, args, prefix) => {
        ...
        if(!args[0] || isNaN(args[0]) || Number(args[0]) < 1 || !args[1] || isNaN(args[1]) || Number(args[1]) < 1)
            return interaction.reply({ ephemeral: true, content: `<:M_x:950441844544794654> **From where to where shall I move?** Usage: \`${prefix}move <fromPosNr.> <toPosNr.>\``}).catch(() => null);
